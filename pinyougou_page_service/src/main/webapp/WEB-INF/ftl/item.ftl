...
<#--扩展属性列表获取处理-->
<#assign customAttributList=goodsDesc.customAttributeItems?eval/>
							...
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										...
										<a href="javascript:void(0)" ng-click="updateNum(1)" class="increment plus">+</a>
										<a href="javascript:void(0)" ng-click="updateNum(-1)" class="increment mins">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#list customAttributList as item>
										<#if item.value?? >
